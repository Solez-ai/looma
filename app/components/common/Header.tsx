      ...
      >
        <div className="max-w-7xl px-6 xl:px-8 mx-auto h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2 group" aria-label="Looma - Go to home">
            <Image src="/svg/logo-looma.svg" alt="" aria-hidden="true" width={50} height={50} style={{ height: "auto" }} />
            <span className="hidden sm:flex text-xl font-bold text-white tracking-tight">Looma</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-8 text-md font-medium text-neutral-400" aria-label="Main navigation">
            ...
            <a href="https://github.com/Solez-ai/looma" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">{t('github')}</a>
            <Link href="/editor" className="hover:text-white transition-colors">{t('editor')}</Link>
          </nav>
