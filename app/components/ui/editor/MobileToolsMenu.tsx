    ...
    return (
        <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
            <Dialog.Trigger asChild>
                <button
                    className="fixed bottom-4 left-4 z-50 size-7 rounded-full shadow-lg shadow-blue-500/50 bg-gradient-primary flex items-center justify-center hover:scale-105 transition-transform active:scale-95 lg:hidden"
                    aria-label="Abrir menú de herramientas"
                >
                    <Icon icon="solar:widget-2-bold-duotone" width="14" className="text-white" aria-hidden="true" />
                </button>
            </Dialog.Trigger>
