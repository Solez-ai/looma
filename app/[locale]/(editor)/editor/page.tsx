...
export default function Editor() {
    ...
    const handleImageExport = useCallback(async (
        ...
        try {
            ...
            link.download = `looma-shot-${Date.now()}.${format}`;
            link.href = url;
            link.click();
                    ...
                    <AnimatePresence>
                        {!isControlPanelOpen && (
                            <TooltipAction label="Abrir panel de control" side="right">
                                ...
                                >
                                    <Link href="/" className="block sm:hidden"><Image src="/svg/logo-looma.svg" alt="Looma" width={24} height={24} className="hover:opacity-80 transition-opacity" /></Link>
